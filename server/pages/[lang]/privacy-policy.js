...
const getStaticProps = async ({
  ...
  const res = await axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${_utils_constants__WEBPACK_IMPORTED_MODULE_4__/* .SERVER */ .c}/api/public/privacy-policy`, {
    headers: {
      "Accept-Language": language
    }
  });
  const privacyPolicy = await res.data;
  return {
    props: {
      language,
      privacyPolicy
